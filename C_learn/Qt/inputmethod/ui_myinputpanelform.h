...
**
** Created: Tue Jan 20 17:54:14 2015
...
public:
    ...
    void setupUi(QWidget *MyInputPanelForm)
    {
        ...
        panelButton_hash->setProperty("buttonValue", QVariant(QChar(100)));
    ...
    void retranslateUi(QWidget *MyInputPanelForm)
    {
        ...
        panelButton_hash->setText(QApplication::translate("MyInputPanelForm", "\342\206\220", 0, QApplication::UnicodeUTF8));
