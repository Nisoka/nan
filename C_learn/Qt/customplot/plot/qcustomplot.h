...
public:
  ...
  */
  ...
  void mZoomOutRectRange(double lower,double upper);
...
private:
  ...
  friend class QCustomPlot;
public slots:
  void ZoomInOut(int flag,QPoint zoomPosition);
  void ZoomInRect(double startKey,double startValue,double endKey,double endValue);
};
...
public:
  ...
  */
  ...
  void mydraw(QCPPainter *painter);
  QCPRange mgetKeyRange();
  void getVisibleDataRange(double &keylower, double &keyupper, double &valuelower, double &valueupper);
protected:
  // property members:
  QCPDataMap *mData;
  QPen mErrorPen;
...
public:
  ...
  */
  ...
  QString tsCrosshairBlackgroudDir;
  QString tsCrosshairText;
  QString tsEventNo;
  QString tsEventMarkPNGDir;
  int tsCrosshairTextYoffset;
